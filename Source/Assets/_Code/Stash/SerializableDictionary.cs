...
// taken from https://forum.unity.com/threads/finally-a-serializable-dictionary-for-unity-extracted-from-system-collections-generic.335797/

/// <summary>
/// Must be extended first to be used.
/// Example:
///     [Serializable]
...
public class SerializableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
{
    ...
    private static class PrimeHelper
    {
        ...
        public static bool IsPrime(int candidate)
        {
            if ((candidate & 1) != 0)
            {
                int num = (int)System.Math.Sqrt((double)candidate);
