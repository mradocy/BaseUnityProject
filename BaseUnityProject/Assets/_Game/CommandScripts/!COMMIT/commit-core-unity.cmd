:: Uses KDiff3 to commit the Core.Unity namespace to the base unity project

@echo OFF
setlocal
pushd "%~dp0"

:: Directory of Core.Unity in this Unity project.
set SOURCE_DIRECTORY=..\..\Libs\Core.Unity

:: Directory of Core.Unity in BaseUnityProject:
set DESTINATION_DIRECTORY=%GAMEDEV_SOURCE_UNITY%\BaseUnityProject\BaseUnityProject\Assets\_Game\Libs\Core.Unity
