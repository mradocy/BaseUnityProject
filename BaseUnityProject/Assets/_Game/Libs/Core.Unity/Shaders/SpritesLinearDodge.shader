// A copy of the built-in Sprites/Default shader, but works like the Linear Dodge blend mode in photoshop (close to Color Dodge)
// From https://forum.unity.com/threads/what-shader-emulates-photoshops-screen-linear-dodge.261097/#post-1729235
Shader "Custom/SpritesLinearDodge" {
