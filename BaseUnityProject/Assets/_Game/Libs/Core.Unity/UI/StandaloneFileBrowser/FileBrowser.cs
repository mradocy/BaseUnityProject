...
// Taken from https://github.com/gkngkc/UnityStandaloneFileBrowser
...
namespace Core.Unity.UI.StandaloneFileBrowser {
    ...
    public static class FileBrowser {
        private static IFileBrowser _platformWrapper = null;

        static FileBrowser() {
#if UNITY_STANDALONE_OSX
            _platformWrapper = new FileBrowserMac();
#elif UNITY_STANDALONE_WIN
            _platformWrapper = new FileBrowserWindows();
#elif UNITY_STANDALONE_LINUX
            _platformWrapper = new FileBrowserLinux();
#elif UNITY_EDITOR
            _platformWrapper = new FileBrowserEditor();
#else
            _platformWrapper = new FileBrowserNone();
#endif
        }
